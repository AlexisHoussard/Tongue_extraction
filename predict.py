...
if __name__ == "__main__":
    ...
    try:
        ...
        n = sys.argv[2]
        #saver.restore(sess, "checkpoints/model.ckpt-" + n) #Uncomment if you want to predict manually from chekcpoint n
        ...
        Image.fromarray(test_image.astype('uint8')).save(output_dir + image_path[-10:-4] + ".png")
        Image.fromarray(predicted_mask.astype('uint8')).save(output_dir + image_path[-10:-4] + "-" + n + "_mask.png")
